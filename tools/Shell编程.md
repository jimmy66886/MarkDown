...
![20230531155508](https://img01.zzmr.club/img/20230531155508.png)

或者说是shell脚本,可以一行一行解释程序

查看系统提供的shell解释器:`cat /etc/shells`
- ![312213](https://img01.zzmr.club/img/312213.png)
- ![20230531160824](https://img01.zzmr.club/img/20230531160824.png)
...
![20230531162006](https://img01.zzmr.club/img/20230531162006.png)
![20230531162046](https://img01.zzmr.club/img/20230531162046.png)

>还有一种执行方式就是直接输文件名:
![20230531162628](https://img01.zzmr.club/img/20230531162628.png)
一执行就提示没有权限了,因为一个文件**默认是只有读写权限的,并没有可执行的权限,所以要先授予该文件以执行权限**
授予权限前:
![20230531162910](https://img01.zzmr.club/img/20230531162910.png)
执行:`chmod +x hello.sh`授予权限,会发现多了一个x,即代表该文件拥有了可执行权限
![20230531162930](https://img01.zzmr.club/img/20230531162930.png)
然后根据绝对路径就可以执行了-相对路径也可,但是**直接输入文件名是不行的**
![20230531163128](https://img01.zzmr.club/img/20230531163128.png)
不过可以根据`./file_name`来执行:
![20230531163428](https://img01.zzmr.club/img/20230531163428.png)
...
2. 案例实操
    - 查看系统变量的值
        - ![20230531165404](https://img01.zzmr.club/img/20230531165404.png)
...
1. 基本语法
    ...
    - ![20230531170957](https://img01.zzmr.club/img/20230531170957.png)
    - ![20230531171515](https://img01.zzmr.club/img/20230531171515.png)
    - 撤销变量:`unset 变量名`
...
![20230531171959](https://img01.zzmr.club/img/20230531171959.png)
...
>下面这种方式不能直接实现赋值:
![20230531173325](https://img01.zzmr.club/img/20230531173325.png)
如果想要实现a=6,那么可以使用`$(())`或者`$[]`
![fdassdafdasf](https://img01.zzmr.club/img/fdassdafdasf.png)
...
```
![20230604105030](https://img01.zzmr.club/img/20230604105030.png)
...
```
![20230604105619](https://img01.zzmr.club/img/20230604105619.png)
![20230604105634](https://img01.zzmr.club/img/20230604105634.png)

- `$*和$@`
    - `$*`:这个变量代表命令行中所有的参数,`$*`把所有的参数看成一个整体
    - `$@`:这个变量也代表命令行中的所有的参数,不过`$@`**把每个参数区别对待(可以用于for循环遍历)**
![20230604110259](https://img01.zzmr.club/img/20230604110259.png)

- `$?`:最后一次执行的命令的返回返回状态,如果这个变量的值为0,证明上一个命令正确执行,如果这个变量的值为非0,则证明上一个命令执行不正确
![20230604110742](https://img01.zzmr.club/img/20230604110742.png)
...
![20230604144915](https://img01.zzmr.club/img/20230604144915.png)

>在Linux中有一个命令专门用于计算数值的表达式:`expr`

![6-4](https://img01.zzmr.club/img/6-4.png)

但是注意,要在运算符左右加上**空格**

但是`*`就不行了,要换成:
![20230604143833](https://img01.zzmr.club/img/20230604143833.png)
...
![2313123213](https://img01.zzmr.club/img/2313123213.png)
...
![20230604154944](https://img01.zzmr.club/img/20230604154944.png)
...
此时看,会发现两者并没有什么区别:
![20230606142645](https://img01.zzmr.club/img/20230606142645.png)

但是把`$*`和`$@`都加上双引号,就能发现区别了:
![20230606142818](https://img01.zzmr.club/img/20230606142818.png)
...
![20230606150820](https://img01.zzmr.club/img/20230606150820.png)

![20230606150941](https://img01.zzmr.club/img/20230606150941.png)
...
![20230606152253](https://img01.zzmr.club/img/20230606152253.png)

>**dirname**

![20230606153132](https://img01.zzmr.club/img/20230606153132.png)
...
![20230606155031](https://img01.zzmr.club/img/20230606155031.png)
...
![20230606173031](https://img01.zzmr.club/img/20230606173031.png)
...
1. `^`:会匹配一行的开头,例如:
![20230606172712](https://img01.zzmr.club/img/20230606172712.png)
2. `$`匹配一行的结束
![20230606173334](https://img01.zzmr.club/img/20230606173334.png)
3. 两个一起用可以匹配空行:
![20230606173829](https://img01.zzmr.club/img/20230606173829.png)
4. `.`通配符,用于代替任何的字符
![20230606174220](https://img01.zzmr.club/img/20230606174220.png)
5. `*`不单独使用,它和上一个字符连用,表示匹配上一个字符0次或多次,下面这个指令就可以匹配`rt,rot,root,rooot等r*t的所有行`
```sh
cat /etc/passwd | grep ro*t
```
6. `.*`两个一起用,表示任意字符任意个数
![20230606174856](https://img01.zzmr.club/img/20230606174856.png)
7. `[]`,字符区间
	- `[]`表示匹配某个范围内的一个字符,例如
	- `[6,8]`匹配6或者8
	- `[0-9]`匹配一个0~9的数字
...
![20230606180419](https://img01.zzmr.club/img/20230606180419.png)

---

匹配手机号:`cat phone_number.sh | grep ^1[34578][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$`
![20230606181152](https://img01.zzmr.club/img/20230606181152.png)

简写:`cat phone_number.sh | grep -E ^1[34578][0-9]{9}$`,`-E`就表示开启扩展语法
![20230606181310](https://img01.zzmr.club/img/20230606181310.png)
...
执行`cut -d " " -f cut.txt`:
![20230607095658](https://img01.zzmr.club/img/20230607095658.png)

换个文件,可以看的更加明显一些
![20230607100155](https://img01.zzmr.club/img/20230607100155.png)
